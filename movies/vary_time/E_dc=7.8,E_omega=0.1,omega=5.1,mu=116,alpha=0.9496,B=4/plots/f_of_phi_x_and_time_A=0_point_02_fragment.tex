...
\begingroup
  ...
  \begin{picture}(14400.00,6048.00)%
    ...
    \gplgaddtomacro\gplbacktext{%
      ...
      \put(3959,1499){\makebox(0,0){\strut{}$E_{dc}=7.8$ $B=4$ $E_{\omega}=0.1$ $\omega=5.1$ $\mu=116$ $\alpha=0.9496$}}%
    }%
    \gplgaddtomacro\gplfronttext{%
    }%
    \gplbacktext
    \put(0,0){\includegraphics{plots/f_of_phi_x_and_time_A=0_point_02_fragment}}%
    \gplfronttext
  \end{picture}%
\endgroup
