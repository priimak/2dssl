...
data = np.genfromtxt('B=4/absorption_omega=2.455_E_omega=0.1_B=4_mu=216_alpha=0.9496_vary_E_dc.data', 
                     delimiter=' ', 
...
data = np.genfromtxt('B=4/absorption_omega=2.455_E_omega=0.1_B=4_mu=116_alpha=0.9496_vary_E_dc.data', 
                     delimiter=' ', 
                     names=['E_dc', 'E_omega', 'omega', 'mu', 'v_dr_inst', 'A', 'NORM', 'v_y_inst', 'm_eff_inst', 'v_dr', 'v_y', 'm_eff'])
...
data = np.genfromtxt('B=4/absorption_omega=2.455_E_omega=0.1_B=4_mu=11.6_alpha=0.9496_vary_E_dc.data', 
                     delimiter=' ', 
                     names=['E_dc', 'E_omega', 'omega', 'mu', 'v_dr_inst', 'A', 'NORM', 'v_y_inst', 'm_eff_inst', 'v_dr', 'v_y', 'm_eff'])
...
data = np.genfromtxt('B=4/absorption_omega=2.455_E_omega=0.1_B=4_mu=1.16_alpha=0.9496_vary_E_dc.data', 
                     delimiter=' ', 
                     names=['E_dc', 'E_omega', 'omega', 'mu', 'v_dr_inst', 'A', 'NORM', 'v_y_inst', 'm_eff_inst', 'v_dr', 'v_y', 'm_eff'])
...
#plt.show()
outfile="plots/v_dr_and_m_vary_E_dc_and_mu.pdf"
