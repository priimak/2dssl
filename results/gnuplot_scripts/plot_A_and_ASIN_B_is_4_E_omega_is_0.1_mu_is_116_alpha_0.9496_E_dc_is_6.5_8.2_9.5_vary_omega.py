...
p = ax.plot([7.0, 7.0], [0.5,10], lw=1.5, color='black', linestyle='--')
...
ax.annotate('b', xy=(6.3,7.7), xycoords='data', fontsize='medium')
ax.annotate('f', xy=(6.8,7.5),  xycoords='data', fontsize='medium')
ax.annotate('e', xy=(7.6,6.9), xycoords='data', fontsize='medium')
ax.annotate('c', xy=(8.0,6.6), xycoords='data', fontsize='medium')
ax.annotate('d', xy=(9.3,7.7), xycoords='data', fontsize='medium')
